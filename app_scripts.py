...
def V2nm(V):
   ...
   Arguments
   V: an array containing the photodetector voltage of the signal of interest

   Output
   dist: an array of distances based specifically on my own unit's calibration (15.21 V/nm) with a 20X high voltage amplifier. 
   This can be changed to work for your own data.
   """
   gain = 20
   dist = gain*V*15.21
   return(dist)
